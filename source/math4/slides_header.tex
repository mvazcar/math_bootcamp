% Shared slide template for the mathematics bootcamp.
...
\definecolor{slidegreen}{HTML}{178A55}
\definecolor{slidered}{HTML}{B93333}
\definecolor{slidegold}{HTML}{C27A16}
...
% Sources are retained in hidden Beamer notes.
\newcommand{\sources}[1]{\note{[Sources] #1}}
