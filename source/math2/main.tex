...
choice set $X=\mathbb{R}_+^L$, continuity is sufficient for a continuous
representation; Day 3 states the theorem.
\end{block}
\end{frame}
...
\par}
\end{frame}
\begin{frame}[t]{MWG Exercises: Utility Representation}
\par
\vspace{.1em}
{\centering
