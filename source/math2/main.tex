...
\begin{center}
\begin{tikzpicture}[x=.78cm,y=.38cm,>=Stealth,font=\footnotesize]
...
Rationality is necessary. On arbitrary uncountable choice sets, it need not be
sufficient; additional structure such as continuity may be required.
\end{block}
\end{frame}
